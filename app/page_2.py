...
with st.container(border=False,horizontal_alignment ="center"):
    with st.container(border=False, width = 1400):
        ...
        st.markdown(
                """
                ###### _Use the :red[Logistic Regression] model to predict whether a customer will churn or not based on the input features._
                """
            )
        ...
        if st.button("Predict Churn", width = 1400):
